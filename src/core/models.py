        ...
        try:
            ...
            if 'order_items' in data and isinstance(data['order_items'], list):
                ...
                for item_data in data['order_items']:
                    ...
                    if 'start_date' in item_data and isinstance(item_data['start_date'], str):
                        item_data['start_date'] = datetime.fromisoformat(item_data['start_date'])
                    if 'end_date' in item_data and isinstance(item_data['end_date'], str):
                        item_data['end_date'] = datetime.fromisoformat(item_data['end_date'])
...
class OrderItemData:
    ...
    def __post_init__(self):
        ...
        # Validate start_date - required, must be datetime object
        if not isinstance(self.start_date, datetime):
            raise ValueError("start_date must be a datetime object")
            
        # Validate end_date - required, must be datetime object
    ...
    def to_worksheet_data(self) -> Dict[str, Any]:
        ...
        if self.previous_report_found is not None:
            worksheet_data["Previous Report Found"] = "Yes" if self.previous_report_found else "No"
        else:
