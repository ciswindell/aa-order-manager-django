...
2. **Directory Search**
   ...
   - The system must search within agency-specific directory structures (separate directories for Federal and NMState)
   - The system must use Dropbox API v2 `/files/search_v2` endpoint for directory searches

3. **Link Generation**
   - The system must generate shareable Dropbox links that work in web browsers
...
5. **Agency Directory Mapping**: Configure agency-specific root directories in the application settings
...
5. **Configuration**: Store app credentials and directory paths in a configuration system separate from business logic
